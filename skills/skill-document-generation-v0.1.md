<!-- skill: document-generation/v0.1 -->
...
文档内的所有颜色必须通过 CSS 变量引用，不允许 hardcode（除上面声明的根值）。
...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Inter:wght@400;500&family=JetBrains+Mono:wght@400&family=Noto+Sans+SC:wght@400;500&family=Noto+Serif+SC:wght@400;500;600&display=swap" rel="stylesheet">
```

**字重只允许 400 和 500 两档**。不要用 600/700——它们会让页面变重。
...
- **进场动效**：随滚动渐入的 fade-up（offset 8–16px，duration 600–800ms，cubic-bezier ease-out）
...
- [ ] 顶部带了 `<!-- skill: document-generation/v0.1 -->` 签名了吗？
